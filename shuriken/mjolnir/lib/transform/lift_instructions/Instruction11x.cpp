...
void Lifter::gen_instruction(shuriken::disassembler::dex::Instruction11x *instr) {
    ...
    switch (op_code) {
        case dex_opcodes::opcodes::OP_RETURN:
        case dex_opcodes::opcodes::OP_RETURN_WIDE:
        case dex_opcodes::opcodes::OP_RETURN_OBJECT: {
        ...
        case dex_opcodes::opcodes::OP_MOVE_RESULT:
        case dex_opcodes::opcodes::OP_MOVE_RESULT_WIDE:
        case dex_opcodes::opcodes::OP_MOVE_RESULT_OBJECT: {
