...
namespace shuriken::parser::dex {
    ...
    public:
        ...
        MethodID(DVMType *class_, ProtoID *protoId, std::string_view name, uint32_t rawMethodId, uint16_t rawClassId) : class_(class_), protoId(protoId), name(name), rawMethodId(rawMethodId), rawClassId(rawClassId) {}
